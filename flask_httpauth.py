...
This module has been slightly modified so that way user passwords could 
be stored in the database in a hash form instead of plain text. 
-Pawel Szczurko (January 2015)
"""
